<?php get_header(); ?>
<div class="single-publication-wrap">

  <section class="publication-intro">
    <div class="l-container">
      <div class="text col-match">
        <div class="text-container" style="-webkit-transform: none; transform: none; top: auto;">
          <div class="publication-details">
            <!-- Category: Publication<br> -->
            <?php the_field('status_text'); ?><br>
            <!-- Author: Nazlee Maghsoudhi (for news)<br> -->
          </div>
          ...
          <div class="publication-links" style="margin-bottom: 0;">
            ...
            <?php if (get_field('pdf_file')) { ?><a target="_blank" class="pdf" href="<?php the_field('pdf_file'); ?>">
