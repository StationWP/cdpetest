 ...
 */
function cdpe_custom_colors_css() {
	 ...
	 */
	$saturation = absint( apply_filters( 'cdpe_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.cdpe-front-page) .entry-title,
...
.colors-custom .cdpe-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.cdpe-front-page .panel-content .recent-posts article,
...
.colors-custom.cdpe-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	 ...
	 */
	return apply_filters( 'cdpe_custom_colors_css', $css, $hue, $saturation );
}
